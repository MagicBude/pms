...
DEFAULT_PERMISSION_NAMES: dict[P, str] = {
    ...
    P.DRAWING_VIEW: "查看物料图纸与订单图纸包",
    P.DRAWING_MANAGE: "上传和替代物料图纸",
    P.DRAWING_PACKAGE_GENERATE: "生成订单图纸包",
    P.PROJECT_VIEW: "查看项目",
...
DEFAULT_ROLE_GRANTS: dict[R, dict[P, S]] = {
    ...
    R.BOM_ENGINEER: {
        ...
        P.DRAWING_VIEW: S.TENANT,
        P.DRAWING_MANAGE: S.TENANT,
        P.PROJECT_VIEW: S.RELATED,
        P.BOM_VIEW: S.RELATED,
    ...
    R.REQUESTER: {
        ...
        P.MATERIAL_VIEW: S.TENANT,
        P.DRAWING_VIEW: S.TENANT,
        P.DRAWING_PACKAGE_GENERATE: S.TENANT,
        P.PROJECT_VIEW: S.RELATED,
        P.BOM_VIEW: S.RELATED,
        P.PRODUCTION_RELEASE_VIEW: S.RELATED,
